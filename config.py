...
class Settings(BaseSettings):
    ...
    system_prompt: str = (
        ...
        "Liste des produits disponibles (utilise uniquement ces produits) :\n"
        "- Bouteille 25kg\n"
        "- Bouteille 50kg\n"
        "- Bouteille 6kg\n"
        "- CONS-6KG\n"
        ...
        "- Pétrole lampant\n"
        "- Super\n"
        "Si le pompiste mentionne un produit qui ne figure pas dans cette liste, "
        "indique-lui que le produit est invalide et demande-lui de choisir parmi les produits disponibles.\n\n"
